...
public class AbstractPlayerInteraction {
    ...
    public final int getPlayerStat(final String type) {
        if (type.equals("LVL")) {
            ...
            return c.getPlayer().getStr();
        } else if (type.equals("DEX")) {
            return c.getPlayer().getDex();
        } else if (type.equals("INT")) {
            return c.getPlayer().getInt();
        } else if (type.equals("LUK")) {
            return c.getPlayer().getLuk();
        } else if (type.equals("HP")) {
            return c.getPlayer().getHp();
        } else if (type.equals("MP")) {
            return c.getPlayer().getMp();
        } else if (type.equals("MAXHP")) {
            return c.getPlayer().getMaxHp();
        } else if (type.equals("MAXMP")) {
            return c.getPlayer().getMaxMp();
