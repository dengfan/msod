...
public class NPCSpawningCommands implements Command {
    ...
    public CommandDefinition[] getDefinition() {
        return new CommandDefinition[]{
                    new CommandDefinition("npc", "npcid", "Spawns the npc with the given id at the player position", 50),
                    new CommandDefinition("pnpc", "npcid", "Spawns the npc with the given id at the player position", 50),
