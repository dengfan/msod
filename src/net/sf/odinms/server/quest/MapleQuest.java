...
public class MapleQuest {
    ...
    private static MapleDataProvider questData = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath", "wz") + "/Quest.wz"));
    ...
    public void start(MapleCharacter c, int npc, boolean force) {
        try {
            ...
            c.getClient().getSession().write(MaplePacketCreator.serverNotice(1, "出错了。\r\n\r\n" + StringUtil.getStackTrace(t)));
        }
    }
