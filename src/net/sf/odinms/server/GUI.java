...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("控制台 for MXMXD079");

        jTabbedPane1.setToolTipText("");

        jButton1.setText("保存所有在线玩家数据");
        ...
        jTabbedPane1.addTab("常用", jPanel1);
        ...
        jTabbedPane1.addTab("玩家", jPanel2);
    ...
    private void printLog(String logStr) {
        String content = jTextPaneLog.getText();
        jTextPaneLog.setText((content.length() > 0 ? content + "\r\n" : "")  + logStr);
    }
