...
public class FileoutputUtil {
    ...
    public static final String fixdam_mg = "log\\Ä§·¨ÉËº¦ÐÞÕý.log",
            ...
            MobVac_log = "log\\Îü¹Ö.log",
            hack_log = "log\\»³ÒÉÍâ¹Ò.log",
            ban_log = "log\\·âºÅ.log",
            Acc_Stuck = "log\\¿¨ÕËºÅ.log",
            Login_Error = "log\\µÇÂ¼´íÎó.log",
            //Timer_Log = "log\\Log_Timer_Except.log",
            //MapTimer_Log = "log\\Log_MapTimer_Except.log",
            IP_Log = "log\\ÕËºÅIP.log",
            //GMCommand_Log = "Log_GMCommand.log",
            Zakum_Log = "log\\ÔúÀ¥.log",
            Horntail_Log = "log\\°µºÚÁúÍõ.log",
            Pinkbean_Log = "log\\Æ·¿ËçÍ.log",
            ScriptEx_Log = "log\\½Å±¾Òì³£.log",
            PacketEx_Log = "log\\·â°üÒì³£.log" // I cba looking for every error, adding this back in.
            + "";
    // End
