...
function start() {
	...
	if (hotSand.countMobOnMap(5220001) == 0 && hotSand.countMobOnMap(5220000) == 0) {
		...
		hotSand.broadcastMessage(Packages.net.sf.odinms.tools.MaplePacketCreator.serverNotice(6, "[Event] A large, blue shell seems to have been washed up onto the beach..."));
	}
	scheduleNew();
}
