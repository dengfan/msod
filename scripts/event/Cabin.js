...
function scheduleNew() {
	...
	if(toggleMsg) {
		KC_docked.broadcastMessage(MaplePacketCreator.serverNotice(1, "航班公告:萌新冒险岛航班K001次开往天空之城的已经到达。"));
		NLC_docked.broadcastMessage(MaplePacketCreator.serverNotice(1, "航班公告:萌新冒险岛航班K002次开往神木村的已经到达。"));
	}
...
function takeoff() {
	...
	if(toggleMsg) {
		KC_docked.broadcastMessage(MaplePacketCreator.serverNotice(1, "航班公告:萌新冒险岛航班K001次开往神木村的已经发出，来不及乘坐的岛民请等候下个班次。"));
		NLC_docked.broadcastMessage(MaplePacketCreator.serverNotice(1, "航班公告:萌新冒险岛航班K002次开往天空之岛的已经发出，来不及乘坐的岛民请等候下个班次。"));
	}
