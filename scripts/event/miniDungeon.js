...
if(em.getInstance(mostRecentRoom) == null){
    ...
    player.getClient().getSession().write(Packages.net.sf.odinms.tools.MaplePacketCreator.serverNotice(1, "To prevent botting, you will be warped out in 60 minutes."));
        player.getClient().getSession().write(Packages.net.sf.odinms.tools.MaplePacketCreator.serverNotice(6, "To prevent botting, you will be warped out in 60 minutes."));
