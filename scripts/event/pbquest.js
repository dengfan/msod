...
function playerEntry(eim, player) { 
 ...
 player.getClient().getSession().write(Packages.net.sf.odinms.tools.MaplePacketCreator.getClock(600));//600为时间限制10分钟。 
 player.getClient().getSession().write(Packages.net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, " 如果你想离开，可以跟我讲话。。")); 
