...
//              return;
//          }
            if (cm.getLevel() < 255 && cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.BEGINNER)) {
                if (cm.getLevel() < 8) {
                ...
                status = 98;
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.ASSASSIN)) {
                status = 63;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.BANDIT)) {
                status = 66;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.HUNTER)) {
                status = 69;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.CROSSBOWMAN)) {
                status = 72;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.FP_WIZARD)) {
                status = 75;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.IL_WIZARD)) {
                status = 78;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.CLERIC)) {
                status = 81;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.FIGHTER)) {
                status = 84;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.PAGE)) {
                status = 87;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.SPEARMAN)) {
                status = 90;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.BRAWLER)) {
                status = 93;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.GUNSLINGER)) {
                status = 96;
                cm.sendYesNo("恭喜你达到了 #r[70级]#k 你现在就要完成 #b[第三次转职]#k 吗？");
            } else if (cm.getLevel() < 120) {
                cm.sendNext("怎么样？冒险还算顺利吧。有努力就有回报。当然这一切都不是容易的。当你到达 #r[120级]#k 的时候就可以进行#b[第四次转职]#k到时别忘记来找我哦！");
                status = 98;
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.HERMIT)) {
                status = 105;
                cm.sendYesNo("恭喜你达到了 #r[120级]#k 你现在就要完成 #b[第四次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.CHIEFBANDIT)) {
                status = 108;
                cm.sendYesNo("恭喜你达到了 #r[120级]#k 你现在就要完成 #b[第四次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.RANGER)) {
                status = 111;
                cm.sendYesNo("恭喜你达到了 #r[120级]#k 你现在就要完成 #b[第四次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.SNIPER)) {
                status = 114;
                cm.sendYesNo("恭喜你达到了 #r[120级]#k 你现在就要完成 #b[第四次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.FP_MAGE)) {
                status = 117;
                cm.sendYesNo("恭喜你达到了 #r[120级]#k 你现在就要完成 #b[第四次转职]#k 吗？");
                ...
                status = 123;
                cm.sendYesNo("恭喜你达到了 #r[120级]#k 你现在就要完成 #b[第四次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.CRUSADER)) {
                status = 126;
                cm.sendYesNo("恭喜你达到了 #r[120级]#k 你现在就要完成 #b[第四次转职]#k 吗？");
                ...
                status = 132;
                cm.sendYesNo("恭喜你达到了 #r[120级]#k 你现在就要完成 #b[第四次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.MARAUDER)) {
                status = 135;
                cm.sendYesNo("恭喜你达到了 #r[120级]#k 你现在就要完成 #b[第四次转职]#k 吗？");
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.OUTLAW)) {
                status = 138;
                cm.sendYesNo("恭喜你达到了 #r[120级]#k 你现在就要完成 #b[第四次转职]#k 吗？");
            ...
            cm.changeJob(job);
            if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.ASSASSIN)) {
            } else if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.BANDIT)) {
           ...
           cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer() + "] ：★★★转职成功！大家祝贺ta★★★ ");
            ...
            if (cm.getJob().equals(Packages.net.sf.odinms.client.MapleJob.HERMIT)) {
                status = 105;
