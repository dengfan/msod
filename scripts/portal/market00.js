...
function enter(pi) {
	var returnMap = pi.getPlayer().getSavedLocation(Packages.net.sf.odinms.server.maps.SavedLocationType.FREE_MARKET);
	if (returnMap < 0) {
		returnMap = 102000000;
	}
	...
	pi.getPlayer().clearSavedLocation(Packages.net.sf.odinms.server.maps.SavedLocationType.FREE_MARKET);
